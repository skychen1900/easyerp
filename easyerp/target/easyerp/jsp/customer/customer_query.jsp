		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<div class="row clearfix">
					...
					<c:url var="get" value="/customerAction!getCustomerAll.do" />
					<div class="col-md-6 column">
						<form class="form-horizontal" role="form" action="${get }" method="post">
						
							<div class="form-group">
								 <label for="inputEmail3" class="col-sm-2 control-label">客户编号</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputEmail3" name="customerNO"/>
								</div>
							</div>
							<div class="form-group">
